/**
 * @file AuthPage.tsx
 * @description Renders the user authentication page, handling both sign-in and sign-up
 * with email/password and Google social login.
 */
...
const AuthPage: React.FC = () => {
  ...
  // State to manage the loading status of buttons.
   ...
   * @param err The error object from Firebase.
   * @returns A friendly error string to display to the user.
   */
  ...
  // Animation variants for the form transition.
        ...
        <div className="relative w-full max-w-4xl h-[600px] grid grid-cols-1 md:grid-cols-2 shadow-2xl rounded-2xl">
            ...
            <div className="relative flex flex-col justify-center p-8 sm:p-12 bg-white rounded-2xl md:rounded-l-none">
                <AnimatePresence mode="wait">
                    <motion.div
                        key={isLogin ? "login" : "signup"} // This key tells Framer Motion to re-animate when the state changes.
